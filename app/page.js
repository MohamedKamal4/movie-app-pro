...
import Hero from'./componads/homePage/heroSection/heroSection'
...
export default async function Home() {
  const trendingData = fetchData(`https://api.themoviedb.org/3/trending/all/day?language=en-US`);
  ...
  return (
    <>
        <Hero data={data} genre={genre.genres} />
    </>
  );
}
