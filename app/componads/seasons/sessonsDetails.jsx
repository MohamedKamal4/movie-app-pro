            ...
            <div className="container py-10 w-full m-auto relative z-[9000]">
              ...
              <div className="w-full flex items-center flex-col">
                ...
                <div className="w-full flex mt-10 h-screen">
                    ...
                    >
                      {uniqueEpisodes?.map((el, idx) => (
                        <SwiperSlide className="p-5" key={`${el.id}-${idx}`}>
                          <div
                            className={`h-[150px] relative w-[100px] overflow-hidden flex items-center justify-center rounded-xl 
                              ${activeIndex === idx ? 'scale-150 shadow-lg' : 'scale-75 opacity-70'} 
                              transition-transform relative z-[1000] duration-300`}
                          >
                            <Image
                              src={`https://image.tmdb.org/t/p/w500${el.still_path || data.poster_path}`}
                              fill
                  ...
                  {item &&
                    <div className="w-[70%] ps-5 flex justify-center items-start flex-col gap-2">
                      <h3 className="text-xs text-amber-300">Episode {item.episode_number}</h3>
                          ...
                          <div className="w-full">
                              <div className="w-full flex justify-between">
                                  ...
                                  { uniqueGuestStars.length > 2 &&
                                      <span className="flex gap-1 pe-5 text-xs items-center">Scroll <FaArrowRight size={10} /></span>
                                  }
                              </div>
                              <div className="flex">
